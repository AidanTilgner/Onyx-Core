...
import InterpretationInterfacer from "utilities/interpretation/interfacer";

const interfacer = new InterpretationInterfacer("chat");
const actionsInterface = interfacer.actions;
const peopleInterface = interfacer.auth;
